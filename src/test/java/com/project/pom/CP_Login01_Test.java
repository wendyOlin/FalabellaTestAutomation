...
/**
 * Esta clase utiliza los métodos de la clase LoginPage, para ingresar a Falabella con correo y contraseña registrado en sistema.
 * @author: Wendy Olín
 * @version: 11/11/2022/A
 */

public class CP_Login01_Test {
	...
	public void testLogin01() throws InterruptedException {
		...
		System.out.println(loginPage.loginMessage());
				
		//Assertions Compara el mensaje de bienvenida retornado al iniciar sesión con el mensaje esperado.
		Assert.assertEquals("Hola,",loginPage.loginMessage());	
	}
